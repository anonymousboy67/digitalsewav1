...
const ProjectSchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__["Schema"]({
    ...
    description: {
        ...
        np: {
            ...
            required: [
                true,
                'Nepali description is required'
            ],
            trim: true,
            maxlength: [
                2000,
    ...
    budget: {
        ...
        min: [
            100,
            'Budget must be at least Rs. 100'
        ]
    },
    deadline: {
        type: String,
...
async function GET(request) {
    try {
        ...
        const [projects, total] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Project$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find(query).populate('client', 'name email').sort({
                createdAt: -1
            }).skip(skip).limit(limit).lean(),
            __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Project$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments(query)
        ]);
...
async function POST(request) {
    try {
        ...
        const { title, description, budget, deadline, skills, category, isUrgent, difficulty, location } = body;
        ...
        // Create the project
        const project = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Project$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            title,
            description,
            budget,
            deadline,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__44d389ed._.js.map