...
const availabilityOptions = [
  { value: 'available', label: 'Available', labelNp: 'उपलब्ध' },
  { value: 'busy', label: 'Busy', labelNp: 'व्यस्त' },
  { value: 'not_available', label: 'Not Available', labelNp: 'उपलब्ध छैन' },
];
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">Only freelancers can create a profile.</p>
      ...
      <div className="max-w-3xl mx-auto">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="mb-8">
            ...
            <p className="text-gray-600 mt-1">आफ्नो फ्रीलान्सर प्रोफाइल बनाउनुहोस्</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent"
                  placeholder="उदाहरण: ग्राफिक डिजाइनर"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent"
                  placeholder="आफ्नो बारेमा र अनुभवको बारेमा लेख्नुहोस्..."
                />
              </div>
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent"
                placeholder="e.g., Logo Design, Photoshop, Illustrator, UI/UX"
              />
            </div>
